-- Fix sp_RunFXRevaluation: avoid period_month column in MERGE ON clause
...
BEGIN
  ...
  BEGIN TRY
    ...
    -- Build revaluation data into a temp table
    SELECT
      c.contract_id,
      c.contract_ref,
      c.currency_code,
    ...
    ALTER TABLE #RevalLeases ADD revalued_lc DECIMAL(18,2), fx_gain_loss DECIMAL(18,2);
...
END
GO
PRINT 'sp_RunFXRevaluation fixed successfully';
