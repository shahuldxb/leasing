...
const FORM_PROMPTS: Record<string, { description: string; schema: Record<string, string> }> = {
  ...
  asset: {
    ...
    schema: {
      ...
      floorArea: "Floor area in sqm as number e.g. 350",
      estimatedMarketValue: "Estimated market value in AED as number e.g. 2500000",
      lastValuationDate: "ISO date YYYY-MM-DD e.g. 2024-01-15",
      makeGoodProvision: "Make good provision amount in AED as number e.g. 50000",
  ...
  contract_milestone: {
    description: "A key contract milestone or deadline for a commercial lease in the UAE",
    schema: {
      ...
      dueDate: "ISO date YYYY-MM-DD e.g. 2025-03-31",
      notes: "Brief description of the milestone action required",
    },
  },
  critical_date: {
    description: "A critical date event for a commercial lease contract in the UAE",
    schema: {
      eventType: "One of: Expiry, Renewal Option, Break Option, Rent Review, Inspection, Insurance Renewal, Regulatory Filing",
      eventDate: "ISO date YYYY-MM-DD e.g. 2025-06-30",
      notes: "Brief description of the action required on this date",
    },
  },
  variable_rent: {
    description: "A variable rent entry (turnover, percentage, or performance-based) for a commercial lease in the UAE",
    schema: {
      period: "Reporting period e.g. 2025-Q1 or 2025-01",
      variableType: "One of: Turnover, Percentage, Performance, Service Charge, Other",
      amount: "Variable rent amount in AED as number e.g. 45000",
      currency: "AED",
      notes: "Brief notes on the variable rent basis",
    },
  },
};
