...
export default function ESignatureIntegration() {
  ...
  const createMut = trpc.eSignature.create.useMutation({
    onSuccess: () => { utils.eSignature.list.invalidate(); toast.success("Record created"); setShowForm(false); },
    onError: (e) => toast.error(e.message),
  });
  const updateMut = trpc.eSignature.updateStatus.useMutation({
    onSuccess: () => { utils.eSignature.list.invalidate(); toast.success("Updated"); setShowForm(false); },
    onError: (e) => toast.error(e.message),
  });
