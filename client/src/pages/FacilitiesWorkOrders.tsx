...
export default function FacilitiesWorkOrders() {
  ...
  const createMut = trpc.workOrder.create.useMutation({
    onSuccess: () => { utils.workOrder.list.invalidate(); toast.success("Record created"); setPanelOpen(false); },
    onError: (e) => toast.error(e.message),
  });
  const updateMut = trpc.workOrder.update.useMutation({
    onSuccess: () => { utils.workOrder.list.invalidate(); toast.success("Updated"); setPanelOpen(false); },
    onError: (e) => toast.error(e.message),
  });
